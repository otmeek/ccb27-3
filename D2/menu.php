...
<body>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li><a href="statsscript.php">Statistics</a></li>
    ...
    <div class="container main">
        ...
        <h1>Menu</h1>
        <!-- display a login successful message and the user's first and last names -->
        <p>Login successful! <?php echo($_SESSION['firstname'].' '.$_SESSION['surname']); ?> is now logged in.</p>
